...
const oilSealTypes = [
  "Simrit Oil Seal",
  "Simrit Oil Seal NBR",
  "Simrit Oil Seal Viton",
  "Simrit Oil Seal Metal Cladded",
  "Simrit Oil Seal PTFE",
  "Simrit Shaft Seal",
  "Simrit HUB Seal",
  "Simrit Cassette Seal",
  "Simrit Gear Box Seal",
  "Simrit Hydraulic Pump Seal",
  "Simrit Seal Kit",
  "Simrit O-Ring",
];
          ...
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row md:items-center">
            <div className="text-center md:text-left md:flex-1">
              <h1 className="text-2xl font-extrabold text-white sm:text-3xl lg:text-4xl">
                Buy Simrit Oil Seal <span className="text-[#f5b400]">| A2Z Seals</span>
              </h1>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300 sm:text-base">
                A2Z Seals, Kolkata, India supplies and distributes Simrit Oil Seals,
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mb-14 rounded-3xl bg-white p-8 shadow-sm border border-slate-200">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            ...
            of Simrit oil seals, serving Indian, Middle East, African
        ...
        <div className="mb-14">
          <div className="mb-6 text-center">
            ...
            <h2 className="mt-2 text-3xl font-extrabold text-[#061a38]">
              Simrit Oil Seal Used Across Industries
            </h2>
          </div>
        ...
        <div className="mb-14">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {oilSealTypes.map((type) => (
              <Link
                key={type}
                to={`/shop/products?brand=simrit&product=${encodeURIComponent(type)}`}
        ...
        <div className="mb-14 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            A2Z Seals offers a full line of replacement Simrit oil seal
        ...
        <div className="mt-12 rounded-3xl bg-[#061a38] px-6 py-8 text-center text-white sm:px-10">
          <h3 className="text-2xl font-extrabold">
            Cannot Find Your Simrit Oil Seal?
          </h3>
...
export default SimritBrandDetail;
