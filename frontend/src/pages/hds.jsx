...
lg:text-[60px]
    ...
    <p
      ...
      "
    >
      Discover premium interior design Portfolio crafted to
...
<section className="relative py-20 overflow-hidden bg-[#050505]">
  ...
  <div className="max-w-[1700px] mx-auto px-6 lg:px-12">
    ...
    {!loading && hds.length === 0 && (
      <div className="text-center py-10">
        <h3 className="text-2xl font-semibold text-white">No Portfolio Available</h3>
        <p className="text-gray-400 mt-2">Portfolio will appear here once added from Admin Panel.</p>
      </div>
    )}
            ...
            <div className="p-5">
              ...
              {item.link && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block text-[#D7B25B] text-sm font-medium hover:underline"
                >
                  View Project
                </a>
              )}
